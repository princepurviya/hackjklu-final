...
export default function FeaturesSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative layout-container" style={{ background: "transparent" }}>
        {/* header */}
        <motion.div
          initial="hidden"
        ...
        >
          {features.map((feat) => (
            <motion.div
              key={feat.title}
              variants={itemVariants}
              className="group relative h-full p-8 rounded-3xl border border-white/[0.06] bg-white/[0.06] hover:border-[#c9a84c]/15 transition-all duration-500"
            >
