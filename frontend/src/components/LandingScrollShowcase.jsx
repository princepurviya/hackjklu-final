...
function Header() {
  return (
    <div
      ...
      className="layout-container showcase-header"
    >
      ...
      <h2 className="showcase-header-title">
        AI-Powered Exhibit <span className="text-[#c9a84c] italic pr-2">Monitoring</span>
      </h2>
      <div className="showcase-header-copy-wrap">
        <p className="showcase-header-copy">
...
function FeatureRow({ item }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <ul className="space-y-4" data-stagger>
          {item.features.map((feat, i) => (
            ...
            >
              <div className="showcase-bullet-icon flex-shrink-0 w-5 h-5 rounded-full bg-[#c9a84c]/10 flex items-center justify-center border border-[#c9a84c]/20">
      ...
      <motion.div 
        data-animate="pop-up"
        className="showcase-media-card w-full max-w-3xl h-[360px] sm:h-[460px] lg:h-[560px] relative rounded-3xl overflow-hidden group"
      >
        ...
        <div className="absolute inset-0 z-10 overflow-hidden rounded-2xl border border-white/[0.05] bg-transparent">
          <motion.img
